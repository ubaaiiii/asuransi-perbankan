...
@foreach($cabangdtls as $cabangdtl)
		...
		<div class="x_content">
			<form class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-6">
							  <input type="text" class="form-control" id="kode" value="<?php echo $cabangdtl->msid; ?>" readonly >  
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							  <input type="text" class="form-control" id="cabang" value="<?php echo $cabangdtl->msdesc; ?>" readonly >  
							</div>
